...
/**
 * HummingbotApiService provides methods to interact with the Hummingbot API
 * through our backend API layer. This service makes real API calls to our
 * backend endpoints that integrate with Hummingbot Gateway.
 */
export class HummingbotApiService {
  private baseUrl = '/api/trading/hummingbot';
...
const hummingbotApi = new HummingbotApiService();
